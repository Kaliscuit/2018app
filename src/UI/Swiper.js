...
export default class extends Component {
    ...
    */
    ...
    getRenderRowLabel() {
        ...
        for (let i = 0; i < count; i++) {
            const dataSourceIndex = this.ezswiper.loop ? (i + maxIndex) % this.ezswiper.count : i
            views.push(<View key={i} style={[styles.label, {
                backgroundColor: this.state.currentIndex === i ? 'rgba(255,255,255,1)' : 'rgba(255,255,255,.6)',
            }]}></View>)
        }
        return views;
    }
    ...
    render() {
        ...
        return (
            <View style={[this.props.style, { overflow: 'hidden' }]}>
                ...
                <View style={[styles.bannerLabels, {bottom:this.props.tp ? px(32) : px(20)}]}>
...
/*bottom:this.props.tp ? px(60) : px(20)}]    60改为了32，20180423修改新快捷入口高度*/
const styles = StyleSheet.create({
    ...
    label: {
        ...
        width: px(19), height: px(5), borderRadius: px(14),
        marginRight: px(6), marginBottom: Platform.OS === 'ios' ? px(-20) : px(1)
    }
})