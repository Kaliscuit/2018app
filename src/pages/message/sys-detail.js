...
class SysList extends List {
    ...
    async load(page) {
        try {
            let res = await get("https://dalingjia.com/msg_box/api/msgList.do?msgType=system_notice&start=" + page)
            return res || {}
        } catch (e) {
            //
        }
...
export default class extends Page {
    ...
    pageBody() {
        return <View style={[styles.container, {
            ...
            <View style={styles.list}>
                <SysList list={this.state.initList} updated={this.backgroundUpdated.bind(this)}
    ...
    async onReady() {
        ...
        try {
            let res = await get("https://dalingjia.com/msg_box/api/msgList.do?msgType=system_notice&start=0")
            this.setState({
                initList: res || {}
            })
        } catch (e) {
