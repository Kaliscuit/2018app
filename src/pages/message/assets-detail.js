...
class AssetsList extends List {
    ...
    renderItem(item, index) {
        ...
        switch (parseInt(iconType)) {
            case 1 : iconUrl = 'icon-message-wallet2';break;
            case 2 : iconUrl = 'icon-message-success2';break;
            case 3 : iconUrl = 'icon-message-card';break;
            case 4 : iconUrl = 'icon-meesage-coin';break;
            case 5 : iconUrl = 'icon-message-user2';break;
        }
    ...
    async load(page) {
        try {
            let res = await get("https://dalingjia.com/msg_box/api/msgList.do?msgType=capital_notice&start=" + page)
            return res || {}
        } catch (e) {
            //
        }
...
export default class extends Page {
    ...
    pageBody() {
        return <View style={styles.container}>
            <View style={styles.list}>
                ...
                <AssetsList list={this.state.initList}
    ...
    async onReady() {
        ...
        try {
            let res = await get("https://dalingjia.com/msg_box/api/msgList.do?msgType=capital_notice&start=0")
            this.setState({
                initList: res || {}
            })
        } catch (e) {
