...
export default class extends React.PureComponent {
    ...
    render() {
        ...
        log("分享:https://dalingjia.com/touch/join-details?sku=" + this.props.goods.sku + "&inviteCode=" + shopDetail.inviteCode + "&f=app&validity=" + this.props.goods.validity)
            ...
            <View style={styles.bottom}>
                ...
                <View style={styles.erweima}>
                    <View style={styles.maziBox}>
                        <QS.QRCode fgColor="#d0648f" value={"https://dalingjia.com/touch/join-details?sku=" + this.props.goods.sku + "&inviteCode=" + shopDetail.inviteCode + "&f=app&validity=" + this.props.goods.validity} size={px(200)} />
