...
export default class extends React.Component {
    ...
    async onSubmit() {
        let [
            ...
            mobile,
            verifyCode] = [
            this.clearSpace(this.state.realName),
                    ...
                    {this.state.initloading
                        ? <View style={styles.main_box}>
                            <View style={styles.view0}>
                                <Text allowFontScaling={false} style={styles.sty0}>为保护账户资金安全，请输入以下姓名身份证号</Text>
                            </View>
                            <View style={styles.view1}>
                                <Text allowFontScaling={false} style={styles.sty1}>姓名</Text>
                                <TextInput
                                    style={styles.sty2}
                                    value={this.state.realName}
                                    placeholder='请输入姓名'
                                    onChangeText={res => this.setState({ realName: res })}
