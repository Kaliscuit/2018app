...
public class DisplayUtil {
	...
	public static int dipToPixel(float dpValue) {
		float scale = MainApplication.getApplication().getResources()
	...
	public static int[] getDeviceWidthHeight() {
		WindowManager wm = (WindowManager) MainApplication.getApplication()
	...
	public static float spTopx(float sp){
		DisplayMetrics metrics = MainApplication.getApplication().getResources()
				.getDisplayMetrics();
